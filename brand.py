...
files = [
    {'input': 'fpt_result.csv', 'output': 'Fpt_with_Brand.csv'},
    {'input': 'gearvn_result.csv', 'output': 'Gearvn_with_Brand.csv'},
    {'input': 'phucanh_result.csv', 'output': 'Phucanh_with_Brand.csv'}
]
